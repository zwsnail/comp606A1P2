...
/*stripslashes() function removes backslashes added by the addslashes() 
  ...
  $price = stripslashes($_POST['price']);
	...
	$created = date("Y-m-d H:i:s");
        $query = "INSERT into user(fullname,gender,birth_date,mob_number,email,password,massage_time,reason,price,created)
		VALUES('$fullname','$gender','$birth_date','$mob_number','$email','".md5($password)."','$massage_time','$reason','$price', '$created')";
        echo $query;  
