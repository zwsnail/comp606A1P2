...
//$reason = stripslashes($_POST['reason']);
  ...
  //$price = stripslashes($_POST['price']);
	...
	$created = date("Y-m-d H:i:s");
        $query = "INSERT into therapist(fullname,gender,birth_date,mob_number,therapist_email,password,created)
		VALUES('$fullname','$gender','$birth_date','$mob_number','$therapist_email','".md5($password)."','$created')";
        echo $query;  
